      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex gap-3 pt-1">
          ...
          <button onClick={onConfirm} disabled={loading}
            className={`flex-1 py-2.5 text-slate-900 dark:text-white text-sm font-bold rounded-lg transition-colors disabled:opacity-60 ${confirmCls}`}>
          ...
          <div className="flex-1 p-6 pb-8 lg:p-8 max-w-[1280px] w-full mx-auto space-y-6">
            ...
            {loading ? (
              ...
              <div className="tonal-card rounded-xl flex flex-col items-center gap-4 py-20 text-center">
                <span className="material-symbols-outlined text-5xl text-slate-600 dark:text-slate-300">inventory_2</span>
                        ...
                        <div className="px-4 py-4 flex flex-col gap-3">
                          ...
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <div className="flex items-center gap-1.5 flex-shrink-0">
                              ...
                              <button onClick={() => setDeleteTarget(job)} title="Delete"
                                className="p-1.5 border border-slate-200 rounded-lg text-slate-500 dark:text-slate-400 hover:text-red-500 hover:border-red-200 transition-colors">
                          ...
                          {skills.length > 0 && (
                            <div className="flex flex-wrap gap-1">
                              ...
                              {skills.length > 5 && <span className="text-xs text-slate-500 dark:text-slate-400 self-center">+{skills.length - 5} more</span>}
                            </div>
                          )}
