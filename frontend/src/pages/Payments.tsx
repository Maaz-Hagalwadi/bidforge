          ...
          <div className="flex-1 p-6 pb-8 lg:p-8 max-w-[1280px] w-full mx-auto space-y-6">
            ...
            {loading ? (
              ...
              <div className="tonal-card rounded-xl flex flex-col items-center gap-4 py-20 text-center border border-outline-variant">
                <span className="material-symbols-outlined text-5xl text-slate-600 dark:text-slate-300 dark:text-slate-600">payments</span>
              ...
              <div className="space-y-5">
                  ...
                  <div className="flex gap-1.5 flex-wrap">
                    {([
                      ...
                      <button key={key}
                        ...
                        {label}
                        <span className={['text-xs px-1.5 py-0.5 rounded-full font-bold', filter === key ? 'bg-white/20 text-slate-900 dark:text-white' : 'bg-slate-100 text-on-surface-variant'].join(' ')}>{count}</span>
                      </button>
                    ))}
                  </div>
                ...
                {filtered.length === 0 ? (
                  <div className="tonal-card rounded-xl flex flex-col items-center gap-4 py-16 text-center border border-outline-variant">
                    <span className="material-symbols-outlined text-5xl text-slate-600 dark:text-slate-300 dark:text-slate-600">search_off</span>
