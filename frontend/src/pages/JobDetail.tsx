...
import { ADMIN_SIDEBAR, CLIENT_SIDEBAR, FREELANCER_SIDEBAR } from '@/constants/sidebar';
...
export default function JobDetail() {
  ...
  const sidebarLinks = isAdmin ? ADMIN_SIDEBAR : user?.role === 'FREELANCER' ? FREELANCER_SIDEBAR : CLIENT_SIDEBAR;

  const activeLabel = isAdmin ? 'Job Moderation'
    : fromPage === 'invites' ? 'My Invites'
